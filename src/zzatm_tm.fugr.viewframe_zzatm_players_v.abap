*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZZATM_PLAYERS_V
*   generation date: 22.11.2020 at 21:12:20
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZZATM_PLAYERS_V     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZZATM_PLAYERS_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZZATM_PLAYERS_V_EXTRACT
TOTAL = ZZATM_PLAYERS_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZZATM_PLAYERS_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZZATM_PLAYERS_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZZATM_PLAYERS_V_EXTRACT
TOTAL = ZZATM_PLAYERS_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZZATM_PLAYERS_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZZATM_PLAYERS_V'
...
TOTAL = ZZATM_PLAYERS_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZZATM_PLAYERS_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZZATM_PLAYERS_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZZATM_PLAYERS_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZZATM_PLAYERS_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZZATM_PLAYERS_V_EXTRACT
TOTAL = ZZATM_PLAYERS_V_TOTAL
