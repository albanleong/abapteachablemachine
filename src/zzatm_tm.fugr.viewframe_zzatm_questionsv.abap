*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZZATM_QUESTIONSV
*   generation date: 11/23/2020 at 23:27:18
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZZATM_QUESTIONSV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZZATM_QUESTIONSV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZZATM_QUESTIONSV_EXTRACT
TOTAL = ZZATM_QUESTIONSV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZZATM_QUESTIONSV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZZATM_QUESTIONSV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZZATM_QUESTIONSV_EXTRACT
TOTAL = ZZATM_QUESTIONSV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZZATM_QUESTIONSV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZZATM_QUESTIONSV'
...
TOTAL = ZZATM_QUESTIONSV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZZATM_QUESTIONSV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZZATM_QUESTIONSV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZZATM_QUESTIONSV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZZATM_QUESTIONSV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZZATM_QUESTIONSV_EXTRACT
TOTAL = ZZATM_QUESTIONSV_TOTAL
