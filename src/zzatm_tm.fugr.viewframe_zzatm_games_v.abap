*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZZATM_GAMES_V
*   generation date: 23.11.2020 at 18:10:02
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZZATM_GAMES_V       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZZATM_GAMES_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZZATM_GAMES_V_EXTRACT
TOTAL = ZZATM_GAMES_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZZATM_GAMES_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZZATM_GAMES_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZZATM_GAMES_V_EXTRACT
TOTAL = ZZATM_GAMES_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZZATM_GAMES_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZZATM_GAMES_V'
...
TOTAL = ZZATM_GAMES_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZZATM_GAMES_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZZATM_GAMES_V-UPD_FLAG NE SPACE.
